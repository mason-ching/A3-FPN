...
class Visualizer:
    ...
    def draw_dataset_dict(self, dic, jittering: bool = True):
        """
        Draw annotations/segmentations in Detectron2 Dataset format.

        Args:
            dic (dict): annotation/segmentation data of one image, in Detectron2 Dataset format.
            jittering (bool): if True, in color mode SEGMENTATION, randomly jitter the colors per class
                to distinguish instances from the same class
    ...
    def draw_box(self, box_coord, alpha=0.8, edge_color="g", line_style="-"):
        """
        Args:
        ...
        linewidth = min(self._default_font_size / 4, 1.5)
        # linewidth = 1.5
    ...
    def draw_binary_mask(
            self, binary_mask, color=None, *, edge_color=None, text=None, alpha=0.8, area_threshold=10
    ):
        """
        Args:
            ...
            text (str | None): if None, will be drawn on the object
            alpha (float): blending efficient. Smaller values lead to more transparent masks.
