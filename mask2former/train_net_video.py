...
# MaskFormer
from mask2former import add_prfpn_mask2former_config
...
def setup(args):
    ...
    add_prfpn_mask2former_config(cfg)
...
def main(args):
    ...
    trainer.register_hooks([
        hooks.BestCheckpointer(eval_period=cfg.TEST.EVAL_PERIOD, checkpointer=trainer.checkpointer,
                               val_metric=cfg.TEST.VAL_METRIC, mode="max"),
    ])
