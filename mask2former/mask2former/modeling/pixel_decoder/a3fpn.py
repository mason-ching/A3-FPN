    ...
    def forward(self, x):
        ...
        if len(x) == 2:
            ...
            if self.using_resampling:
                ...
                # feature_map_visualization(sampled_feat3, module_type='last_fusion',
                #                           save_dir="feats_visualization_with_resample_with_weight_with_assemble_3")
                # draw_heatmap(sampled_feat3, module_type='last_fusion',
                #              save_dir="heat_map_feats_visualization__with_resample_with_weight_with_assemble_3",
                #              )
                # feature_map_visualization(sampled_feat2, module_type='last_fusion',
                #                           save_dir="feats_visualization_with_resample_with_weight_with_assemble_2")
                # draw_heatmap(sampled_feat2, module_type='last_fusion',
                #              save_dir="heat_map_feats_visualization__with_resample_with_weight_with_assemble_2",
                #              )
...
class Body(nn.Module):
    ...
    def forward(self, x):
        ...
        # bottom-up
        # output0 = self.a3fpn_4_level0((x0, x1, x2, x3))
        # output1 = self.a3fpn_4_level1((x0, x1, x2, x3))
        # output2 = self.a3fpn_4_level2((x0, x1, x2, x3))
        # x3 = self.a3fpn_4_level3((x0, x1, x2, x3))
        ...
        outputs = [output0, output1, output2, x3]
