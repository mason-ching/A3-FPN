...
if __name__ == '__main__':
    main()
# python ./mmdetection/tools/analysis_tools/get_flops.py a3fpn_cascade_mask-rcnn_r50_3x_coco-iter.py
# python ./mmdetection/tools/analysis_tools/benchmark.py a3fpn_faster-rcnn_r50_1x_coco.py --checkpoint weight/a3fpn_mask_rcnn_coco_3x_ms/best_coco_segm_mAP_epoch_36.pth --work-dir result
