...
model = dict(
    ...
    neck=dict(
        ...
        num_repblocks=1,
        expansion=4.,
        using_resampling=[True, True, True],
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        dataset=dict(
            ...
            data_prefix=dict(img='images/instances_UAVtrain/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_prefix=dict(img='images/instances_UAVval/images/'),
        test_mode=True,
...
default_hooks = dict(
    ...
    checkpoint=dict(type='CheckpointHook', by_epoch=False, interval=2000, save_best='auto', max_keep_ckpts=3,
                    save_last=True),
    sampler_seed=dict(type='DistSamplerSeedHook'),
    visualization=dict(type='DetVisualizationHook', draw=True, interval=200)
)
