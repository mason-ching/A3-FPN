...
from mmdet.visualization.det_cam_visualizer import (DetAblationLayer,
...
def parse_args():
    ...
    parser.add_argument(
        ...
        default=False,
        action='store_true',
        help='Whether to use test time augmentation, default not to use')
    parser.add_argument(
        '--eigen-smooth',
        default=False,
        action='store_true',
...
def main():
    args = parse_args()
    model, det_cam_visualizer = init_model_cam(args, args.config)
    ...
    for image_path in images:
        ...
        # image_rgb = image[:, :, ::-1]  # 等同于 image[..., [2, 1, 0]]
...
if __name__ == '__main__':
    main()
# 'python ./mmdetection/demo/vis_cam.py /home/mengen/Desktop/object_detection/000000535578.jpg ./mmdetection/configs/faster_rcnn/faster-rcnn_r50_fpn_1x_coco.py mmdetection/weight/object_det/faster_rcnn_r50_fpn_1x_coco_20200130-047c8118.pth --method 'ablationcam' --preview-model'